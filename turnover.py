...
def turnover(start_date, end_date, product):
    ...
    if product == "all":
        ...
        print(f"The total turnover from {start_date} until {end_date} for {product} is {turnover:.2f}.")
...
parser.add_argument("start_date", help="Enter start date for timeframe (format: yyyy-m-d).")
parser.add_argument("end_date", help="Enter end date for timeframe (format: yyyy-m-d).")
